...
###############################################################################
# Stage 2: LoRA Fine-tuning from Custom Pretrained Backbone + Heads
#
# Based on train_wan22_stage2_finetune_custom_pretrained.sh, but uses LoRA
# to adapt the DiT backbone while loading custom motion/depth heads.
###############################################################################
...
USE_WANDB=true
WANDB_PROJECT="wan22-ti2v-stage2-lora-large"
WANDB_NAME="wan22-ti2v-stage2-lora-large-custom-pretrained"
...
# Output
OUTPUT_PATH="${MODEL_BASE_PATH}/wan22_ti2v_stage2_lora_large_custom_pretrained"
...
echo "=========================================================================="
echo "Stage 2 LoRA Fine-tuning (Large Dataset)"
echo "=========================================================================="
...
accelerate launch --mixed_precision bf16 --num_processes 4 \
  ...
  $([ -n "$LORA_CHECKPOINT" ] && echo "--lora_checkpoint $LORA_CHECKPOINT" || echo "") \
