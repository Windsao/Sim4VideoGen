...
# Configuration
NUM_GPUS=4
SCRIPT="./run_physics_iq_inference.sh"

# Pass through all arguments to each instance
EXTRA_ARGS="$@"

echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  4-GPU Parallel Inference Launcher${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
echo "This will launch 4 parallel processes:"
echo "  GPU 0: Processing shard 0/4 (samples 0-24)"
echo "  GPU 1: Processing shard 1/4 (samples 25-49)"
echo "  GPU 2: Processing shard 2/4 (samples 50-74)"
echo "  GPU 3: Processing shard 3/4 (samples 75-99)"
echo ""
...
echo "  - View logs: tail -f physics_iq_results/inference_shard*.log"
echo ""
echo "To check running processes:"
echo "  ps aux | grep inference_physics_iq_wan22.py"
echo ""
echo "To kill all processes:"
echo "  pkill -f inference_physics_iq_wan22.py"
echo ""
...
echo "  python merge_shard_reports.py"
echo ""
